...
Just ilke the previous dataset, \( B \) contains a great amount of tdata about users that don't belong to the telco. We define \( B_N \) as the bank users which belong to the telco: \( \left( \forall \left( t_0 \cdots t_3 \right) \in phones\left( B_N \right) \right) \left( \exists i \right) t_i \in N \).
