...
Where $\alpha^j_i = a^j_i +1$, are the parammeters of de distribution, and $\Beta$ represents the Beta distribution function, deffined according to (\ecref{Beta})
