...
Instead of predicting the exact value of a users income, our strategy is to distinguish between only two income categories, $R_1 = \left[1000, 2500\right)$ and $R_2 = \left[2500, \infty\right)$, that is users with low or high income respectively, which we place into two distinct groups $ H_1, H_2 \subseteq G$:
\[
