...
In order to validate our proposed methodology, we constructed 5 binary classifiers, one for each income group, which selects whether a given user belongs to that category.
