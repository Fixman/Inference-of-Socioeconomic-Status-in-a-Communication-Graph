...
In order to validate our proposed methodology, for each category we constructed 

 
In particular, we can create 5 binary classifiers, one for each income group, which can take one of four results depending on whether the caller or the calee belong to it.
...
\caption{ \protect\input{figures/ROC_multiclass/caption}}
