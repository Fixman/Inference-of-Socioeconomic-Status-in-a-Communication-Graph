...
\[
r_s = \rho_{\operatorname{rank}(X) \operatorname{rank}(Y)} = \frac{\operatorname{cov}(\operatorname{rank}(x), \operatorname{rank}(y)), \sigma_{\operatorname{rank}(x)} \sigma_{\operatorname{rank}(y)}}
\]