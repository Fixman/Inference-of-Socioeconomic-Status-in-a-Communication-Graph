...
establish links with others of similar age. This phenomenon is called homophily~\cite{birds of a feather}, and has been verified in communications graph~\cite{kenya,brea}
as well as the Facebook graph~\cite{anatomy of FB}.

Economic factors are also believed to have an determining role in social network dynamics.
However, there are still very few quantitative analyses (on a large scale) on the interplay between 
economic status of individuals and their social network.
In~\cite{marton}, the authors analyze the correlations between mobile phone data and banking transaction information, revealing the existence of social stratification. They also show the presence of homophily respect to socioeconomic indicators, such as income, purchases and debt.
